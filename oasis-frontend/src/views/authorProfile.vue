  ...
  <el-container class="main">
    ...
    <el-main>
      <el-row :gutter="15">
        <el-col :span="16"
          ><div class="basic-info">
            <basic-intro-card :intro="basicIntro"></basic-intro-card></div
        ></el-col>
        <el-col :span="8"
          ><div class="basic-info">
            <basic-statistic-card
              :statistics="basicStatistic"
            ></basic-statistic-card></div
        ></el-col>
      </el-row>
      <el-row :gutter="15">
        <el-col :span="8"
          ><div class="grid-content">
            <graph-card :graphInfo="graphInfos[0]"></graph-card></div
        ></el-col>
        <el-col :span="8"
          ><div class="grid-content">
            <graph-card :graphInfo="graphInfos[1]"></graph-card></div
        ></el-col>
        <el-col :span="8"
          ><div class="grid-content">
            <graph-card :graphInfo="graphInfos[2]"></graph-card></div
        ></el-col>
      </el-row>
      <el-row :gutter="15">
        <el-col :span="8"
          ><div class="grid-content">
            <graph-card :graphInfo="graphInfos[3]"></graph-card></div
        ></el-col>
        <el-col :span="8"
          ><div class="grid-content">
            <graph-card :graphInfo="graphInfos[4]"></graph-card></div
        ></el-col>
        <el-col :span="8"
          ><div class="grid-content">
            <NodeCard
      ...
      <el-row :gutter="15">
        <el-col :span="8"
          ><div class="grid-content">
            <pie-chart-card :chartData="pieChartData"></pie-chart-card></div
        ></el-col>
        <el-col :span="16"
          ><div class="grid-content">
      ...
      <el-row :gutter="15">
        <el-col :span="24"
          ><div class="grid-content">
            <top-ranking-card
              :topRankingContent="topRankingContent[0]"
              :pdfLink="true"
            ></top-ranking-card></div
        ></el-col>
      </el-row>
    </el-main>
  </el-container>
...
import AuthorTrendCard from '@/components/AuthorTrendCard'
...
export default {
  ...
  components: {
    ...
    'author-trend-card': AuthorTrendCard
  },
  ...
  methods: {
    getBasicInfo () {
      getRequest('/api/author/detail?id=' + this.id).then(res => {
    ...
    getNodeInfo () {
      getRequest('/api/graph/author/?id=' + this.id).then(res => {
        if (res.status === 200) {
